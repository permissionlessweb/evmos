...
import (
	...
	icqtypes "github.com/evmos/evmos/v14/x/interchainquery/types"
)

const (
	ICQCallbackID_SolidityCall        = "soliditycall"
)

// ICQCallbacks wrapper struct for ibcsolidity keeper
...
func (c ICQCallbacks) RegisterICQCallbacks() icqtypes.QueryCallbacks {
	return c.
		AddICQCallback(ICQCallbackID_SolidityCall, ICQCallback(SolidityCallCallback)).
