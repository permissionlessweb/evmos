...
var (
	...
	ErrIBCSolidity                         = errorsmod.Register(ModuleName, 1504, "IBC solidity call failed")
	...
	ErrInvalidIBCSolidityContract          = errorsmod.Register(ModuleName, 1545, "Invalid solidity contract string")
